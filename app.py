...
##################################################################################################################################
    ...
    if st.session_state.triggered:
        ...
        if data["status"] != "1":
            ...
            # === AFFICHAGE GROUPE 1
            explications1 = {
                "- Résumé": "Ce résumé présente les **meilleurs paramètres** choisis automatiquement pour entraîner le modèle XGBoost. On observe une **précision de 95,63%**, ce qui signifie que 95 transactions sur 100 sont bien classifiées. Le taux d’erreur est inférieur à 5%, ce qui est un excellent score en classification.",
